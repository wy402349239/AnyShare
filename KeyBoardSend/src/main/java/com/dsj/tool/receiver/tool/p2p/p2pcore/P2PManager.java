package com.dsj.tool.receiver.tool.p2p.p2pcore;
...
import com.dsj.tool.receiver.tool.p2p.p2pentity.param.ParamReceiveFiles;
import com.dsj.tool.receiver.tool.p2p.p2pentity.param.ParamSendFiles;
import com.dsj.tool.receiver.tool.p2p.p2pentity.param.ParamStrEntity;
import com.dsj.tool.receiver.tool.p2p.p2pentity.param.ParamTCPNotify;
import com.dsj.tool.receiver.tool.p2p.p2pinterface.Melon_Callback;
import com.dsj.tool.receiver.tool.p2p.p2pinterface.ReceiveFile_Callback;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case P2PConstant.CommandNum.SEND_FILE_REQ: //收到请求发送文件
                    ...
                    break;
                case P2PConstant.CommandNum.SEND_STR_REQ: //收到请求字符串
                    if (manager.receiveFile_callback != null) {
                        ParamStrEntity params = (ParamStrEntity) msg.obj;
                        manager.receiveFile_callback.AfterRecriverStr(params);
                    }
                    break;
